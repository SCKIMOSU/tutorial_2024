...
class UserList(generics.ListAPIView): # generics.ListCreateAPIView 는 User 생성도  가능 (?)
...
# ################################################
# # # 3. CBV : Response by APIView, not by api_view
# ################################################
from snippets.models import Snippet
from snippets.serializers import SnippetSerializer
...
# from snippets.serializers import SnippetSerializer
#
# # 응답이 더 이상 단일 콘텐츠 유형에 고정되어 있지 않다는
# # 사실을 활용하기 위해 API 엔드포인트에 형식 접미사에
# # 대한 지원을 추가해 보겠습니다.
#
...
################################################
# # 1. FBV : Response by  JsonResponse
################################################
